...
extension MaxListLength<T> on List<T> {
  List<T> truncate(int end) {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children:[
        ...
        Text(
          nationalizeResponse.data!.countries.map((e) => '${countryCodeToName[e.countryCode.toUpperCase()] ?? e.countryCode} ${(e.probability*100).round()} %').toList().truncate(5).join('\n'),
